...
const { BAD_REQUEST, SERVER_ERROR, PAGE_NOT_FOUND, SUCCESS, CREATED } = exceptionConstants

const SubtaskAddForm = (props) => {
    const { project, addSubtask } = props
    ...
    const handleSubmit = async () => {
        ...
        const res = await addSubtask(data)
        switch(res.code){
            case CREATED:
                setRedirect(true)
                break;
...
export default connect(mapStateToProps, null)(SubtaskAddForm)